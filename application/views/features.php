...
<body id="features">
  ...
  <main id="main">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6" data-aos="fade-left">
            <img src="<?= base_url('assets/img/undraw_svg_2.svg')?>" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
    ...
    <img src="<?= base_url('assets/img/undraw_svg_3.svg') ?>" alt="Image" class="img-fluid">
</div>
